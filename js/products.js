...
const BICIFAST_PRODUCTS = [
  ...
  {
    id: "cortador-timones-truper",
    name: "Cortador de Timones y Tijas Truper",
    brand: "Truper",
    category: "accesorios",
    categoryLabel: "Accesorios y Repuestos",
    price: 40,
    ...
    rating: 4.6,
    reviews: 2,
    short: "Herramienta Truper para cortar timones y tijas de bicicleta.",
    description: "Cortador de timones y tijas Truper. Herramienta de taller para ajustar la medida del manubrio y la tija de asiento.",
    image: "img/productos/accesorios/cortador-timones-truper.jpg",
    gallery: ["img/productos/accesorios/cortador-timones-truper.jpg"],
    colors: [],
    sizes: [],
    unavailableSizes: [],
    specs: { "Uso": "Cortar timones y tijas", "Marca": "Truper" },
    installments: null
  },
  {
    id: "tacos-freno-icestop",
    name: "Tacos de Freno IceStop",
    brand: "IceStop",
    category: "accesorios",
    categoryLabel: "Accesorios y Repuestos",
    price: 15,
    ...
    rating: 4.5,
    reviews: 2,
    short: "Par de tacos de freno IceStop para aro de aluminio, el blíster.",
    description: "Tacos de freno IceStop para MTB, aptos para aro de aluminio. Precio por blíster (par).",
    image: "img/productos/accesorios/tacos-freno-icestop.jpg",
    gallery: ["img/productos/accesorios/tacos-freno-icestop.jpg"],
    colors: [],
    sizes: [],
    unavailableSizes: [],
    specs: { "Uso": "Aro de aluminio", "Presentación": "Blíster (par)" },
    installments: null
  },
  {
    id: "extractor-cadena-tw",
    name: "Extractor de Cadena TW",
    brand: "TW",
    category: "accesorios",
    categoryLabel: "Accesorios y Repuestos",
    price: 30,
    ...
    rating: 4.5,
    reviews: 2,
    short: "Extractor de cadena TW, herramienta de taller para bicicleta.",
    description: "Extractor de cadena TW. Herramienta de taller para desarmar y ajustar la cadena de la bicicleta.",
    image: "img/productos/accesorios/extractor-cadena-tw.jpg",
    gallery: ["img/productos/accesorios/extractor-cadena-tw.jpg"],
    colors: [],
    sizes: [],
    unavailableSizes: [],
    specs: { "Uso": "Extraer y ajustar cadena", "Marca": "TW" },
    installments: null
  },
  {
    id: "llave-hexagonal-tw",
    name: "Llave Hexagonal TW",
    brand: "TW",
    category: "accesorios",
    categoryLabel: "Accesorios y Repuestos",
    price: 25,
    ...
    rating: 4.5,
    reviews: 2,
    short: "Llave hexagonal tipo Y, marca TW.",
    description: "Llave hexagonal tipo Y (3 medidas), marca TW.",
    image: "img/productos/accesorios/llave-hexagonal-tw.jpg",
    gallery: ["img/productos/accesorios/llave-hexagonal-tw.jpg"],
    colors: [],
    sizes: [],
    unavailableSizes: [],
    specs: { "Tipo": "Llave Y", "Marca": "TW" },
    installments: null
  },
  {
    id: "llave-hexagonal-truper",
    name: "Llave Hexagonal Truper",
    brand: "Truper",
    category: "accesorios",
    categoryLabel: "Accesorios y Repuestos",
    price: 25,
    ...
    rating: 4.7,
    reviews: 2,
    short: "Juego de llaves hexagonales Truper, acerado, 9 piezas plegables.",
    description: "Juego de llaves hexagonales Truper, acerado (acero Cr-V), 9 piezas en organizador plegable, medidas de 1.3mm a 6mm.",
    image: "img/productos/accesorios/llave-hexagonal-truper.jpg",
    gallery: ["img/productos/accesorios/llave-hexagonal-truper.jpg"],
    colors: [],
    sizes: [],
    unavailableSizes: [],
    specs: { "Material": "Acero Cr-V", "Piezas": "9", "Medidas": "1.3mm a 6mm" },
    installments: null
  },
  {
    id: "llave-box-acerada",
    name: "Llave Box Acerada",
    brand: "BOW",
    category: "accesorios",
    categoryLabel: "Accesorios y Repuestos",
    price: 30,
    ...
    rating: 4.5,
    reviews: 2,
    short: "Llave box acerada para taller de bicicletas.",
    description: "Llave box acerada, herramienta de taller para ajustes de bicicleta.",
    image: "img/productos/accesorios/llave-box-acerada.jpg",
    gallery: ["img/productos/accesorios/llave-box-acerada.jpg"],
    colors: [],
    sizes: [],
    unavailableSizes: [],
  ...
  {
    id: "tacos-freno-vibrake-shimano",
    name: "Tacos para Frenos V-Brake Shimano",
    brand: "Shimano",
    category: "accesorios",
    categoryLabel: "Accesorios y Repuestos",
    price: 20,
    ...
    rating: 4.6,
    reviews: 2,
    short: "Par de tacos para frenos v-brake, marca Shimano.",
    description: "Tacos para frenos tipo v-brake, marca Shimano.",
    image: "img/productos/accesorios/tacos-freno-vibrake-shimano.jpg",
    gallery: ["img/productos/accesorios/tacos-freno-vibrake-shimano.jpg"],
    colors: [],
    sizes: [],
    unavailableSizes: [],
    specs: { "Tipo": "V-brake", "Marca": "Shimano" },
    installments: null
  },
  {
    id: "llave-hexagonal-truper-thor",
    name: "Llave Hexagonal Truper Diseño Thor",
    brand: "Truper",
    category: "accesorios",
    categoryLabel: "Accesorios y Repuestos",
    price: 25,
    ...
    rating: 4.6,
    reviews: 2,
    short: "Llave hexagonal Truper diseño Thor, multimedidas, plegable.",
    description: "Llave hexagonal Truper diseño Thor, multimedidas, formato plegable de bolsillo.",
    image: "img/productos/accesorios/llave-hexagonal-truper-thor.jpg",
    gallery: ["img/productos/accesorios/llave-hexagonal-truper-thor.jpg"],
    colors: [],
    sizes: [],
    unavailableSizes: [],
    specs: { "Diseño": "Thor", "Medidas": "Multimedidas", "Formato": "Plegable" },
    installments: null
  },
  {
    id: "extractor-cadena-parktool",
    name: "Extractor de Cadena Parktool",
    brand: "Parktool",
    category: "accesorios",
    categoryLabel: "Accesorios y Repuestos",
    price: 85,
    ...
    rating: 4.8,
    reviews: 2,
    short: "Extractor de cadena Parktool, herramienta profesional de taller.",
    description: "Extractor de cadena Parktool. Herramienta profesional de taller para desarmar y ajustar la cadena de la bicicleta.",
    image: "img/productos/accesorios/extractor-cadena-parktool.jpg",
    gallery: ["img/productos/accesorios/extractor-cadena-parktool.jpg"],
    colors: [],
    sizes: [],
    unavailableSizes: [],
    specs: { "Uso": "Extraer y ajustar cadena", "Marca": "Parktool" },
    installments: null
  }
];
